...
#ifndef RELATEDUI_SWIFT_H
#define RELATEDUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RelatedUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9RelatedUI10GridLayout")
...
SWIFT_PROTOCOL("_TtP9RelatedUI16GridViewProtocol_")
@protocol GridViewProtocol
@property (nonatomic, readonly, strong) UIView * _Null_unspecified view;
- (CGSize)imageSize SWIFT_WARN_UNUSED_RESULT;
- (UIImageView * _Nonnull)imageView SWIFT_WARN_UNUSED_RESULT;
- (CGPoint)imagePosition SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC9RelatedUI28NavigationControllerDelegate")
...
SWIFT_PROTOCOL("_TtP9RelatedUI16PageViewProtocol_")
...
SWIFT_CLASS("_TtC9RelatedUI10Transition")
